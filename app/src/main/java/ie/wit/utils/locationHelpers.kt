...
fun setCurrentLocation(app: CarBookingApp) {
...
@SuppressLint("MissingPermission")
fun trackLocation(app: CarBookingApp) {
...
fun setMapMarker(app: CarBookingApp) {
...
fun getAllBookings(app: CarBookingApp) {
...
fun getFavouriteBookings(app: CarBookingApp) {
    val bookingsList = ArrayList<BookingModel>()
...
fun addMapMarkers(dl : ArrayList<BookingModel>, map: GoogleMap) {
    dl.forEach {
        map.addMarker(
